...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Munnipopz/Fridaybot"
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("**ᴛʜᴇ ʟᴀᴛᴇꜱᴛ ʙʀᴀɴᴄʜ** `ᴍᴀꜱᴛᴇʀ` **ʜᴀꜱ ʙᴇᴇɴ ᴘᴜꜱʜᴇᴅ ᴛᴏ ʜᴇʀᴏᴋᴜ▣™** \n**ɴᴏᴡ ᴛʀʏɪɴɢ ᴀ ʀᴇꜱᴛᴀʀᴛ ᴛᴏ ᴄᴏᴍᴘʟᴇᴛᴇ ᴜᴘᴅᴀᴛɪᴏɴ ᴘʀᴏᴄᴇꜱꜱ ⚠️ !!** \n ᵀᵒ ᶜʰᵉᶜᵏ ᴵᶠ ᴵ ᵃᵐ ᴬˡⁱᵛᵉ ᴶᵘˢᵗ ᴰᵒ `.ᵃˡⁱᵛᵉ` ᵒʳ `.ʰᵉˡᵖ` !!!! ᵀʰᵃⁿᵏ ᶠᵒʳ ᵁˢⁱⁿᵍ ᶠʳⁱᵈᵃʸ ᵁˢᵉʳᵇᵒᵗ ˢᵉʳᵛⁱᶜᵉ➲\n⇩⇩⇩⇩⇩⇩⇩⇩\n💟@Munnipopz💟")
