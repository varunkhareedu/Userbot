...
async def carbon_api(e):
 ...
 if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
   ...
   await e.edit("⬜⬜⬜⬜⬜")
   CARBON = https://carbon.now.sh/?bg=rgba(157%252C255%252C0%252C1)&t=seti&wt=none&l=auto&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%2525&si=false&es=2x&wm=false&code=%252540Movies_company}'
   CARBONLANG = "en"
